...
public class UserPartedMessage extends DefaultMessage {
    ...
    ** Constructor
     */
    public UserPartedMessage(@NonNull Map<Value, Value> message, @NonNull SocketMessageType.MessageKind messageKind, @NonNull SocketMessageType.MessageKind idKind) {
