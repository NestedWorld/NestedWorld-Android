package com.nestedworld.nestedworld.network.socket.models.message.generic;
...
public class ResultMessage extends DefaultMessage {
    ...
    ** Constructor
     */
    public ResultMessage(@NonNull Map<Value, Value> message, @NonNull SocketMessageType.MessageKind messageKind, @Nullable SocketMessageType.MessageKind idKind) {
